...
class Ms_Plugin_Template {

	/**
	 * The single instance of Ms_Plugin_Template.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	/**
	 * Main Ms_Plugin_Template Instance
	 *
	 * Ensures only one instance of Ms_Plugin_Template is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Ms_Plugin_Template()
	 * @return Main Ms_Plugin_Template instance
	 */
